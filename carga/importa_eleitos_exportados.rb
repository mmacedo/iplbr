...
tabela_de_partidos = {
  "PRB"     => 10, # a partir de 2008
  "PP"      => 11, # a partir de 2004
  # "PPB"     => 11, # até 2000
  "PDT"     => 12,
  "PT"      => 13,
  "PTB"     => 14,
  ...
  "PTN"     => 19,
  "PSC"     => 20,
  "PCB"     => 21, # a partir de 2000
  # "PL"      => 22, # até 2004
  "PR"      => 22, # a partir de 2008
  "PPS"     => 23,
  # "PFL"     => 25, # até 2004
  "DEM"     => 25, # a partir de 2008
  # "PAN"     => 26,
  "PSDC"    => 27,
  "PRTB"    => 28,
  # "PCO"     => 29, # poucos
  # "PGT"     => 30, # a partir de 2000
  # "PSN"     => 31, # até 1996
  "PHS"     => 31, # a partir de 2000
  "PMN"     => 33,
  # "PRN"     => 36, # até de 2000
  "PTC"     => 36, # a partir de 2004
  "PSB"     => 40,
  "PV"      => 43,
  "PRP"     => 44,
  # "PSD"     => 41, # até 2000
  "PSDB"    => 45,
  "PSOL"    => 50, # a partir de 2008
  # "PRONA"   => 56, # até 2004
  "PC do B" => 65,
  "PT do B" => 70
}
