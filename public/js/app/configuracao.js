  ...
  window.Configuracao = (function() {
    ...
    Configuracao.partidosAntigos = {
      mapear: [
        ...
        { de: { sigla: 'PTN',    numero: 19 }, para: 'Antigo PTB' },
        { de: { sigla: 'PASART', numero: 30 }, para: 'Antigo PTB' },
        { de: { sigla: 'PNT',    numero: 67 }, para: 'Antigo PTB' },
        { de: { sigla: 'PNTB',   numero: 81 }, para: 'Antigo PTB' },
        { de: { sigla: 'PTdoB',  numero: 70 }, para: 'Antigo PTB' },
        ...
        { de: { sigla: 'PCdoB',  numero: 65 }, para: 'PCB' },
